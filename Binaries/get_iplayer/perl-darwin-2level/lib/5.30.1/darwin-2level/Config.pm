...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.30.1/darwin-2level'),
    ...
    osvers => '19.0.0',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.30.1'),
    scriptdir => relocate_inc('.../'),
    sitearchexp => relocate_inc('.../../lib/site_perl/5.30.1/darwin-2level'),
    sitelibexp => relocate_inc('.../../lib/site_perl/5.30.1'),
    so => 'dylib',
    useithreads => undef,
