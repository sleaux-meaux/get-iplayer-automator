...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BUILD_GNU_TYPE': 'aarch64-apple-darwin21.3.0',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc',
 'CCSHARED': '',
 ...
 'CONFIG_ARGS': "'MACOSX_DEPLOYMENT_TARGET=10.10' "
                "'--prefix=.' '--enable-shared' "
                "'--with-universal-archs=universal2' '--enable-universalsdk' "
                "'--with-openssl=/opt/local/libexec/openssl3' "
                "'--without-static-libpython' '--without-tcltk-libs' "
                "'--without-tcltk-includes' 'NO_AS_NEEDED='",
 'CONFINCLUDEDIR': './include',
 'CONFINCLUDEPY': './include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Users/skovatch/src/cpython/coverage.info',
 'COVERAGE_REPORT': '/Users/skovatch/src/cpython/lcov-report',
 ...
 'HAVE_ZLIB_H': 0,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'aarch64-apple-darwin21.3.0',
 ...
 'LIBMPDEC_CFLAGS': '-Wsign-compare -Wunreachable-code -DNDEBUG -g -fwrapv -O3 '
                    ...
                    '-isysroot '
                    '/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.1.sdk  '
                    '-I./Modules/_decimal/libmpdec -DUNIVERSAL=1',
 'LIBMPDEC_HEADERS': '\\',
 'LIBMPDEC_OBJS': '\\',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': './lib/pkgconfig',
 'LIBPL': './lib/python3.11/config-3.11-darwin',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.11.a',
 'LIBRARY_DEPS': 'libpython3.11.dylib',
 'LIBRARY_OBJS': '\\',
 ...
 'LINK_PYTHON_DEPS': 'libpython3.11.dylib',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/opt/local/libexec/openssl3/include',
 'OPENSSL_LDFLAGS': '-L/opt/local/libexec/openssl3/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_LIBRARY_PATH=/Users/skovatch/src/cpython',
 'SCRIPTDIR': './lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_LIBRARY_PATH=/Users/skovatch/src/cpython ./python.exe',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_LIBRARY_PATH=/Users/skovatch/src/cpython ./python.exe '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': '".."',
 'WASM_STDLIB': '"".."/local/lib/python3.11/os.py"',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/Users/skovatch/src/cpython',
 'abs_srcdir': '/Users/skovatch/src/cpython',
 'datarootdir': './share',
 'exec_prefix': '.',
 'prefix': '.',
 'srcdir': '.'}
